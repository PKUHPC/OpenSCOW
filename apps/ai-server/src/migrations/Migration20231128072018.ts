...
export class Migration20231128072018 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql("create table `algorithm_version` (`id` int unsigned not null auto_increment primary key, `version_name` varchar(255) not null, `version_description` varchar(255) not null, `path` varchar(255) not null, `create_time` DATETIME(6) not null default current_timestamp(6), `is_shared` tinyint(1) not null, `algorithm_id` int unsigned not null) default character set utf8mb4 engine = InnoDB;");
    this.addSql("alter table `algorithm_version` add index `algorithm_version_algorithm_id_index`(`algorithm_id`);");

    this.addSql("create table `dataset` (`id` int unsigned not null auto_increment primary key, `name` varchar(255) not null, `owner` varchar(255) not null, `type` varchar(255) not null, `is_shared` tinyint(1) not null, `scene` varchar(255) not null, `description` varchar(255) not null, `create_time` DATETIME(6) not null default current_timestamp(6)) default character set utf8mb4 engine = InnoDB;");
    this.addSql("alter table `dataset` add unique `dataset_name_unique`(`name`);");

    this.addSql("create table `dataset_version` (`id` int unsigned not null auto_increment primary key, `version_name` varchar(255) not null, `version_description` varchar(255) not null, `path` varchar(255) not null, `create_time` DATETIME(6) not null default current_timestamp(6), `is_shared` tinyint(1) not null, `dataset_id` int unsigned not null) default character set utf8mb4 engine = InnoDB;");
    this.addSql("alter table `dataset_version` add index `dataset_version_dataset_id_index`(`dataset_id`);");

    this.addSql("create table `image` (`id` int unsigned not null auto_increment primary key, `name` varchar(255) not null, `owner` varchar(255) not null, `source` varchar(255) not null, `tags` varchar(255) not null, `description` varchar(255) not null, `path` varchar(255) not null, `is_shared` tinyint(1) not null, `create_time` DATETIME(6) not null default current_timestamp(6)) default character set utf8mb4 engine = InnoDB;");
    this.addSql("alter table `image` add unique `image_name_unique`(`name`);");

    this.addSql("create table `modal` (`id` int unsigned not null auto_increment primary key, `name` varchar(255) not null, `owner` varchar(255) not null, `algorithm_framework` varchar(255) not null comment 'algorithm algorithmFramework', `algorithm_name` varchar(255) not null comment 'algorithm name', `is_shared` tinyint(1) not null, `description` varchar(255) not null, `create_time` DATETIME(6) not null default current_timestamp(6)) default character set utf8mb4 engine = InnoDB;");
    this.addSql("alter table `modal` add unique `modal_name_unique`(`name`);");

    this.addSql("create table `modal_version` (`id` int unsigned not null auto_increment primary key, `version_name` varchar(255) not null, `version_description` varchar(255) not null, `algorithm_version` varchar(255) not null, `path` varchar(255) not null, `create_time` DATETIME(6) not null default current_timestamp(6), `is_shared` tinyint(1) not null, `modal_id` int unsigned not null) default character set utf8mb4 engine = InnoDB;");
