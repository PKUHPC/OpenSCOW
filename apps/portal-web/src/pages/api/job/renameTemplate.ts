...
export const RenameTemplateSchema = typeboxRouteSchema({
  method: "POST",
...
export default /* #__PURE__*/route(RenameTemplateSchema, async (req, res) => {
  ...
  return asyncUnaryCall(client, "renameTemplate", {
