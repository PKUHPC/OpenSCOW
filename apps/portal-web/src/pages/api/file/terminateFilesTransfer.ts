...
export interface TerminateFilesTransferSchema {
  method: "POST";
  ...
  responses: {
    204: null;
    415: {
      code: "SCOW-SYNC-TERMINATE_CMD_FAILED";
...
export default route<TerminateFilesTransferSchema>("TerminateFilesTransferSchema", async (req, res) => {
