...
import type { GetSessionsSchema } from "src/pages/api/job/getSessions";
...
export const api = {
  ...
  getSessions: fromApi<GetSessionsSchema>("GET", join(process.env.NEXT_PUBLIC_BASE_PATH || "", "/api/job/getSessions")),
