...
import { CreateAndEditAlgorithmModal } from "./CreateAndEditModalModal";
...
export const ModalTable: React.FC<Props> = ({ isPublic }) => {
  ...
  const { data, isFetching, error } = trpc.modal.getModals.useQuery({ ...pageInfo, ...query });
