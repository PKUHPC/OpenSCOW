...
import type { UnsetInitAdminSchema } from "src/pages/api/init/unsetAsInitAdmin";
...
export const api = {
  ...
  getOperationLog: apiClient.fromTypeboxRoute<typeof GetOperationLogsSchema>("GET", "/api/log/getOperationLog"),
};
