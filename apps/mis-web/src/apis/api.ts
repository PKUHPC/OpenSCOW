...
import type { ChangeDBEmailSchema } from "src/pages/api/profile/changeDBEmail";
...
export const api = {
  ...
  changeDBEmail: apiClient.fromTypeboxRoute<typeof ChangeDBEmailSchema>("PATCH", "/api/profile/changeDBEmail"),
