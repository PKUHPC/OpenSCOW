...
// 没有权限返回undefined
export interface ChangePasswordForPlatformAdminSchema {
...
export default /* #__PURE__*/route<ChangePasswordForPlatformAdminSchema>(
  "ChangePasswordForPlatformAdminSchema", async (req, res) => {
