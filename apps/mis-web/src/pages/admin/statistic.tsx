...
import {
  MoneyCollectOutlined, PlayCircleOutlined, ProjectOutlined,
  TeamOutlined, UserOutlined, WalletOutlined,
...
export const PlatformStatisticsPage: NextPage =
  ...
  (() => {
    ...
    const getStatisticInfoFn = useCallback(async () => {
      return await api.getStatisticInfo({
        query: {
    ...
    const getNewUserCountFn = useCallback(async () => {
      return await api.getNewUserCount({
        query: {
          startTime: query.filterTime[0].startOf("day").toISOString(),
          endTime: query.filterTime[1].endOf("day").toISOString(),
          timeZone,
    ...
    const getActiveUserCountFn = useCallback(async () => {
      return await api.getActiveUserCount({
        query: {
          startTime: query.filterTime[0].startOf("day").toISOString(),
          endTime: query.filterTime[1].endOf("day").toISOString(),
          timeZone,
    ...
    const getTopChargeAccountFn = useCallback(async () => {
      return await api.getTopChargeAccount({
        query: {
          startTime: query.filterTime[0].startOf("day").toISOString(),
          endTime: query.filterTime[1].endOf("day").toISOString(),
        },
    ...
    const { data: topChargeAccount, isLoading: topChargeAccountLoading } =
        useAsync({ promiseFn: getTopChargeAccountFn });

    const getTopPayAccountFn = useCallback(async () => {
      return await api.getTopPayAccount({
        query: {
          startTime: query.filterTime[0].startOf("day").toISOString(),
          endTime: query.filterTime[1].endOf("day").toISOString(),
        },
    ...
    const getDailyChargeFn = useCallback(async () => {
      return await api.getDailyCharge({
        query: {
          startTime: query.filterTime[0].startOf("day").toISOString(),
          endTime: query.filterTime[1].endOf("day").toISOString(),
          timeZone,
    ...
    const getUsersWithMostJobSubmissionsFn = useCallback(async () => {
      return await api.getUsersWithMostJobSubmissions({
        query: {
          startTime: query.filterTime[0].startOf("day").toISOString(),
          endTime: query.filterTime[1].endOf("day").toISOString(),
        },
    ...
    const getNewJobCountFn = useCallback(async () => {
      return await api.getNewJobCount({
        query: {
          startTime: query.filterTime[0].startOf("day").toISOString(),
          endTime: query.filterTime[1].endOf("day").toISOString(),
          timeZone,
    ...
    const getPortalUsageCountFn = useCallback(async () => {
      return await api.getPortalUsageCount({
        query: {
          startTime: query.filterTime[0].startOf("day").toISOString(),
          endTime: query.filterTime[1].endOf("day").toISOString(),
        },
    ...
    const { data: portalUsageCount, isLoading: portalUsageCountLoading } =
        useAsync({ promiseFn: getPortalUsageCountFn });

    const getMisUsageCountFn = useCallback(async () => {
      return await api.getMisUsageCount({
        query: {
          startTime: query.filterTime[0].startOf("day").toISOString(),
          endTime: query.filterTime[1].endOf("day").toISOString(),
        },
