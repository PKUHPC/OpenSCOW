...
export const OperationTypeTexts = {
  ...
  [OperationType.USER_SET_JOB_TIME_LIMIT]: "用户设置作业时限",
  ...
  [OperationType.RENAME_DIRECTORY]: "重命名文件夹",
  [OperationType.MOVE_FILE]: "移动文件",
  [OperationType.MOVE_DIRECTORY]: "移动文件夹",
  [OperationType.COPY_FILE]: "复制文件",
  [OperationType.COPY_DIRECTORY]: "复制文件夹",
  [OperationType.ACCOUNT_SET_JOB_TIME_LIMIT]: "账户设置作业时限",
  ...
  [OperationType.TENANT_SET_JOB_TIME_LIMIT]: "租户设置作业时限",
...
export const OperationCodeMap = {
  ...
  [OperationType.USER_SET_JOB_TIME_LIMIT]: "010103",
  ...
  [OperationType.RENAME_FILE]: "010506",
  [OperationType.RENAME_DIRECTORY]: "010507",
  [OperationType.MOVE_FILE]: "010508",
  [OperationType.MOVE_DIRECTORY]: "010509",
  [OperationType.COPY_FILE]: "010510",
  [OperationType.COPY_DIRECTORY]: "010511",
  [OperationType.ACCOUNT_SET_JOB_TIME_LIMIT]: "020101",
  ...
  [OperationType.TENANT_SET_JOB_TIME_LIMIT]: "030101",
