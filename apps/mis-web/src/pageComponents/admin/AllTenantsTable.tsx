  ...
  return (
    <>
      <Table
        ...
        scroll={{ x: true }}
      >
        <Table.Column<GetTenantInfoResponse> dataIndex="tenantId" title="租户ID"></Table.Column>
        <Table.Column<GetTenantInfoResponse> dataIndex="tenantName" title="租户名称" />
        <Table.Column<GetTenantInfoResponse> dataIndex="userCount" title="用户数量" />
        <Table.Column<GetTenantInfoResponse> dataIndex="accountCount" title="账户数量" />
