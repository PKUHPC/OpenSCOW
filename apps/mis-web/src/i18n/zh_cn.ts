...
export default {
  ...
  operationLog: {
    ...
    operationDetails: {
      ...
      accountSetChargeLimit: "在账户{0}中设置用户{1}限额为{2}元",
      accountUnsetChargeLimit: "在账户{0}中取消用户{1}限额",
      setTenantBilling: "设置租户{0}的计费项{1}价格为{2}元",
      ...
      accountPay: "为账户{}充值{}元",
      blockAccount: "在租户{0}中封锁账户{1}",
      unblockAccount: "在租户{0}中解封帐户{1}",
      importUsers1: "给租户{}导入用户，",
      importUsers2: "在账户{0}下导入用户{1}",
      ...
      exportAccountChargeRecordOfTenant: "导出租户{0}内账户{1}的消费记录",
      exportAccountsChargeRecordOfTenant: "导出租户{0}内账户{1}的消费记录",
      ...
      exportAccountPayRecordOfTenant: "导出租户{0}内账户{1}的充值记录",
      exportAccountsPayRecordOfTenant:"导出租户{0}内账户{1}的充值记录",
      ...
      exportJobsOfAccountAndUser: "导出租户{0}内用户{1}在账户{2}执行过的作业列表",
      exportJobsOfUser: "导出租户{0}内用户{1}执行过的作业列表",
      exportJobsOfAccount: "导出租户{0}内账户{1}执行过的作业列表",
      exportJobsOfJobId: "导出租户{0}内执行过的ID为{1}的作业列表",
      exportJobsOfJobIdAndUser: "导出租户{0}内用户{1}执行过的ID为{2}的作业列表",
      exportJobsOfJobIdAndAccount: "导出租户{0}内账户{1}执行过的ID为{2}的作业列表",
      exportJobsOfTenant: "导出租户{}内执行过的作业列表",
