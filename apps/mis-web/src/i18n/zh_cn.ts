...
export default {
  ...
  operationLog: {
    ...
    operationDetails: {
      ...
      createDataset:"添加数据集(集群: {}, 数据集: {})",
      updateDataset:"更新数据集(数据集: {})",
      deleteDataset:"删除数据集(数据集: {})",
      createDatasetVersion:"添加数据集版本(数据集: {}, 数据集版本: {})",
      updateDatasetVersion:"更新数据集版本(数据集: {}, 数据集版本: {})",
      shareDatasetVersion:"分享数据集版本(数据集: {}, 数据集版本: {})",
      copyDatasetVersion:"复制数据集版本(源数据集: {}, 源版本: {}; 目标数据集: {}, 版本: {})",
      deleteDatasetVersion:"删除数据集版本(数据集: {}, 数据集版本: {})",
      createUser: "创建用户{}",
