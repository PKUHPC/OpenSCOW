...
export default {
  ...
  operationLog: {
    ...
    operationDetails: {
      ...
      exportJobsOfAccountAndUser: "导出租户{}内用户{}在账户{}执行过的作业列表",
      exportJobsOfUser: "导出租户{}内用户{}执行过的作业列表",
      exportJobsOfAccount: "导出租户{}内账户{}执行过的作业列表",
      exportJobsOfJobId: "导出租户{}内执行过的ID为{}的作业列表",
      exportJobsOfJobIdAndUser: "导出租户{}内用户{}执行过的ID为{}的作业列表",
      exportJobsOfJobIdAndAccount: "导出租户{}内账户{}执行过的ID为{}的作业列表",
