...
export default {
  ...
  operationLog: {
    ...
    operationDetails: {
      ...
      exportJobsOfAccountAndUser: "Export Job Record executed by user {} in account {} in tenant {}",
      exportJobsOfUser: "Export Job Record executed by user {} in tenant {}",
      exportJobsOfAccount: "Export Job Record executed by account {} in tenant {}",
      exportJobsOfJobId: "Export Job Record with ID {} executed in tenant {}",
