...
export default {
  ...
  pageComp: {
    accounts: {
      accountTable: {
        ...
        unblockConfirmContent: "Do you wish to unblock account {1} within tenant {0}?",
        ...
        blockConfirmContent: "Do you wish to block account {1} within tenant {0}?",
  ...
  page: {
    ...
    tenant: {
      ...
      accounts: {
        ...
        create: {
          tenantNotExistUser: "User {1} does not exist in tenant {0}.",
  ...
  operationLog: {
    ...
    operationTypeTexts: {
      ...
      compressFiles: "Compress File/Directory",
    ...
    operationDetails: {
      ...
      compressFiles: "Compress File/Folder: {} to {}",
      ...
      accountSetChargeLimit: "Set charge limit for user {1} in account {0} to {2} yuan",
      accountUnsetChargeLimit: "Unset charge limit for user {1} in account {0}",
      setTenantBilling: "Set billing item for tenant {0} to {2} yuan per {1}",
      ...
      blockAccount: "Block account {1} in tenant {0}",
      unblockAccount: "Unblock account {1} in tenant {0}",
      importUsers1: "Add user to tenant {}, ",
      importUsers2: "Add user {1} to account {0}",
      ...
      exportAccountChargeRecordOfTenant: "Export Charge Record of Account {1} in Tenant {0}",
      exportAccountsChargeRecordOfTenant: "Export Charge Record of Accounts {1} in Tenant {0}",
      ...
      exportAccountPayRecordOfTenant: "Export Payment Record of Account {1} in Tenant {0}",
      exportAccountsPayRecordOfTenant: "Export Payment Record of Accounts {1} in Tenant {0}",
      ...
      exportJobsOfAccountAndUser: "Export Job Record executed by user {1} in account {2} in tenant {0}",
      exportJobsOfUser: "Export Job Record executed by user {1} in tenant {0}",
      exportJobsOfAccount: "Export Job Record executed by account {1} in tenant {0}",
      exportJobsOfJobId: "Export Job Record with ID {1} executed in tenant {0}",
      exportJobsOfJobIdAndUser: "Export Job Record with ID {2} executed by user {1} in tenant {0}",
      exportJobsOfJobIdAndAccount: "Export Job Record with ID {2} executed by account {1} in tenant {0}",
      exportJobsOfTenant: "Export Job Record executed in tenant {}",
