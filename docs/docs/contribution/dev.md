...
本项目配置了[VSCode Dev Container](https://code.visualstudio.com/docs/devcontainers/containers)功能，您可以使用`.devcontainer`下的配置自动从GitHub打开一个Codespace或者使用VSCode生成一个开发用的容器。容器启动后，将会自动启动devenv开发测试环境。具体如何使用，请参考Dev Container的文档。
